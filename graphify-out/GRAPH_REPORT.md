...
Cohesion: 0.05
Nodes (36): acquired, allVerdicts, analysis, analysisPrompt, drawdown, existing, isForce, lastOpportunityRefreshByRun (+28 more)

### Community 8 - "Community 8"

Cohesion: 0.06
Nodes (31): buildAnalysisBasis(), buildDataBlock(), buildFundamentalsBlock(), buildPortfolioSummaryPrompt(), buildPrompt(), OPPORTUNITY_ANALYSIS_SYSTEM_INSTRUCTIONS, PORTFOLIO_SUMMARY_SYSTEM_INSTRUCTIONS, SYSTEM_INSTRUCTIONS (+23 more)
...
Cohesion: 0.2
Nodes (13): analyzeEntity(), CHART_READER_CONCURRENCY, fetchStockAnalysisCandles(), fetchYahooCandles(), KNOWN_NAME_EXCEPTIONS, namesPlausiblyMatch(), normalizedWords(), rangeMetrics() (+5 more)

### Community 16 - "Community 16"

Cohesion: 0.29
Nodes (13): actionTypes, addToRemoveQueue(), count, dispatch(), genId(), listeners, memoryState, reducer() (+5 more)
...
Cohesion: 0.53
Nodes (4): Dialog, DialogClose, DialogPortal, DialogTrigger
