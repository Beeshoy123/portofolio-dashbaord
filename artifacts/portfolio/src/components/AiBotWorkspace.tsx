...
const VERDICT_FLAG_MAP: Record<string, { en: string; ar: string; explanation: { en: string; ar: string }; category: 'info' | 'warning' }> = {
  ...
  incomplete_technical_data: { en: 'Chart data unavailable', ar: 'بيانات الرسم غير متاحة', explanation: { en: 'No trustworthy chart data was available for this entity, so unavailable values are shown as missing rather than estimated or filled with a fallback.', ar: 'لا تتوفر بيانات موثوقة للرسم البياني لهذا الأصل، لذلك تظهر القيم غير المتاحة كبيانات مفقودة بدلاً من تقديرها أو ملئها بقيمة بديلة.' }, category: 'info' },
